...
Usage:
    GOLD32_BASE_URL=http://127.0.0.1:8144 \
    M144_LOG="D:/Rapids AI/muhafiz-m144/backend.log" \
    M144_PROBES=scratchpad/probes_before.json M144_OUT=scratchpad/before.json \
    M144_RUNS=3 M144_ARM=before python scripts/module144_live_runs.py
"""
...
BASE = os.environ.get("GOLD32_BASE_URL", "http://127.0.0.1:8144")
EMAIL = os.environ.get("EVAL_ADMIN_EMAIL", "admin@example.com")
PW = os.environ.get("EVAL_ADMIN_PASSWORD", "MuhafizAdmin2026!")
LOG = os.environ.get("M144_LOG", os.path.join(HERE, "backend.log"))
OUT = os.environ.get("M144_OUT", os.path.join(HERE, "scratchpad", "module144_runs.json"))
PROBES_PATH = os.environ.get("M144_PROBES", "")
RUNS = int(os.environ.get("M144_RUNS", "1"))
ARM = os.environ.get("M144_ARM", "after")
IDS = [i for i in (os.environ.get("M144_IDS") or "").split(",") if i]
...
def dissect(text):
    xagg, fallbacks, quota, hosts, verifier = [], [], [], [], []
