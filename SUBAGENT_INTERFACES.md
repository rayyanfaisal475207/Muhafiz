...
**Status:** **Implemented and live** — see the design record it was extracted from,
[`AGENT_HARNESS_DESIGN.md`](AGENT_HARNESS_DESIGN.md) (root, not `docs/`). This file carries
the contracts; it is a companion to that design doc, not a replacement for it — the *why*
