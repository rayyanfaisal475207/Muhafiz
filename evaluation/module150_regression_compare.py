# -*- coding: utf-8 -*-
"""
Module 150 — §7 regression: this branch's 32-question run on `:8150` against
...
plus per-question Groq fallbacks read from the backend log.
    ...
    PYTHONPATH=. python -X utf8 evaluation/module150_regression_compare.py
"""
...
LIVE = ROOT / "docs" / "gold-qa-wave2-results" / "module150_live"
OURS = LIVE / "module150_gold32_outputs.json"
LOG = LIVE / "backend_8150.log"
