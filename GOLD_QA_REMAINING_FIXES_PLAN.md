...
| 21 | XNETWORK/XGRAPH relevance-gate over-refusal | `fix/xnetwork-relevance-gate-over-refusal` | ✅ Investigated — no fix belongs in this module's files, see below |
...
| 28 | CR4 routing miss (weapon-recovery chain sent to cross-case entity linkage) | *(not yet branched)* | ⬜ New — split out of Module 21, see below |
| 29 | Meta-Analysis decomposer doesn't split broad synthesis asks into XAGG-shaped sub-questions (CR3/G1/G6) | *(not yet branched)* | ⬜ New — split out of Module 21, see below |
