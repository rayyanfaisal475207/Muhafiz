...
| 82 | KB2 — the answer is built on Module 37 orphans, not on the bar | `MODULE82_RESULT.md` | done — **root-caused; the generation fix was measured, found harmful, and deleted.** Art. 38 reaches the window 0/3 for gold and 3/3 for a paraphrase, split out as Module 93 |
